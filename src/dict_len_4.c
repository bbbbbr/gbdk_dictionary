...
INCBIN(dict_4_a, "src/dict/4_a_words.txt")
INCBIN(dict_4_b, "src/dict/4_b_words.txt")
INCBIN(dict_4_c, "src/dict/4_c_words.txt")
INCBIN(dict_4_d, "src/dict/4_d_words.txt")
INCBIN(dict_4_e, "src/dict/4_e_words.txt")
INCBIN(dict_4_f, "src/dict/4_f_words.txt")
INCBIN(dict_4_g, "src/dict/4_g_words.txt")
INCBIN(dict_4_h, "src/dict/4_h_words.txt")
INCBIN(dict_4_i, "src/dict/4_i_words.txt")
INCBIN(dict_4_j, "src/dict/4_j_words.txt")
INCBIN(dict_4_k, "src/dict/4_k_words.txt")
INCBIN(dict_4_l, "src/dict/4_l_words.txt")
INCBIN(dict_4_m, "src/dict/4_m_words.txt")
INCBIN(dict_4_n, "src/dict/4_n_words.txt")
INCBIN(dict_4_o, "src/dict/4_o_words.txt")
INCBIN(dict_4_p, "src/dict/4_p_words.txt")
INCBIN(dict_4_q, "src/dict/4_q_words.txt")
INCBIN(dict_4_r, "src/dict/4_r_words.txt")
INCBIN(dict_4_s, "src/dict/4_s_words.txt")
INCBIN(dict_4_t, "src/dict/4_t_words.txt")
INCBIN(dict_4_u, "src/dict/4_u_words.txt")
INCBIN(dict_4_v, "src/dict/4_v_words.txt")
INCBIN(dict_4_w, "src/dict/4_w_words.txt")
INCBIN(dict_4_x, "src/dict/4_x_words.txt")
INCBIN(dict_4_y, "src/dict/4_y_words.txt")
INCBIN(dict_4_z, "src/dict/4_z_words.txt")
