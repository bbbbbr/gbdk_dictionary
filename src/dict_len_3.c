...
INCBIN(dict_3_a, "src/dict/3_a_words.txt")
INCBIN(dict_3_b, "src/dict/3_b_words.txt")
INCBIN(dict_3_c, "src/dict/3_c_words.txt")
INCBIN(dict_3_d, "src/dict/3_d_words.txt")
INCBIN(dict_3_e, "src/dict/3_e_words.txt")
INCBIN(dict_3_f, "src/dict/3_f_words.txt")
INCBIN(dict_3_g, "src/dict/3_g_words.txt")
INCBIN(dict_3_h, "src/dict/3_h_words.txt")
INCBIN(dict_3_i, "src/dict/3_i_words.txt")
INCBIN(dict_3_j, "src/dict/3_j_words.txt")
INCBIN(dict_3_k, "src/dict/3_k_words.txt")
INCBIN(dict_3_l, "src/dict/3_l_words.txt")
INCBIN(dict_3_m, "src/dict/3_m_words.txt")
INCBIN(dict_3_n, "src/dict/3_n_words.txt")
INCBIN(dict_3_o, "src/dict/3_o_words.txt")
INCBIN(dict_3_p, "src/dict/3_p_words.txt")
INCBIN(dict_3_q, "src/dict/3_q_words.txt")
INCBIN(dict_3_r, "src/dict/3_r_words.txt")
INCBIN(dict_3_s, "src/dict/3_s_words.txt")
INCBIN(dict_3_t, "src/dict/3_t_words.txt")
INCBIN(dict_3_u, "src/dict/3_u_words.txt")
INCBIN(dict_3_v, "src/dict/3_v_words.txt")
INCBIN(dict_3_w, "src/dict/3_w_words.txt")
INCBIN(dict_3_x, "src/dict/3_x_words.txt")
INCBIN(dict_3_y, "src/dict/3_y_words.txt")
INCBIN(dict_3_z, "src/dict/3_z_words.txt")
